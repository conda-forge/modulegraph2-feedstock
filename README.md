...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/modulegraph2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10884&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/modulegraph2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `modulegraph2` can be installed with:

```
conda install modulegraph2
```

It is possible to list all of the versions of `modulegraph2` available on your platform with:
